    ...
    <section id="skills" class="skills section-bg">
      <div class="container1">
        <div class="section-title">
          <h2>Skills</h2>
          <p>
          For over a monts, I have studied and done some practice projects that breathe life into the realm of the internet.
          through which I tried to improve my web development skills.
          Which helped me to gain an insight of various skill mentioned below
          </p>
        </div>
